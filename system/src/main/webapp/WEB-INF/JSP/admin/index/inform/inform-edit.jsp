                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="text" name="inf_title" required lay-verify="required" placeholder="请输入标题" autocomplete="off" class="layui-input"
                               value="${inform.inf_title}">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">发布人ID：</label>
                    <div class="layui-input-block">
                        <input type="text" name="pre_id" disabled autocomplete="off" class="layui-input layui-disabled" value="${inform.pre_id}">
                    </div>
                </div>
                <div class="layui-form-item layui-form-text">
                    <label class="layui-form-label">通知内容：</label>
                    <div class="layui-input-block">
                        <textarea placeholder="请输入内容" class="layui-textarea">${inform.inf_msg}</textarea>
                    </div>
                </div>
